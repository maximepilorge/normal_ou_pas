...
# pour chaque ville de 1950 à aujourd'hui, avec une sauvegarde incrémentale. 
...
recuperer_donnees_era5 <- function(villes_a_telecharger = NULL) { 
  ...
  # On télécharge un petit échantillon de données pour trouver les mailles les plus proches de chaque ville
  ...
  for (year_to_download in annee_debut:2026) {
